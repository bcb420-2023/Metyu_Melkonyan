...
```
## Breakdown of the supplementary file links of list above
...
```{r}
sfiles = GEOquery::getGEOSuppFiles('GSE158659')
...
```
```{r}
gse <- GEOquery::getGEO("GSE164730",GSEMatrix = FALSE)
...
```
 ** Platform title ** `current_gpl_info$title`
